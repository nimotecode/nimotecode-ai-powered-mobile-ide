---
layout: home
title: NimoteCode - Mobile SSH developer workspace
titleTemplate: false
description: Edit files, run terminals, review Git changes, ask AI, and diagnose remote projects from phone or tablet.
...
<section class="home-page-section">
  <div class="home-page-cta">
    <h2 class="home-page-cta-title">Open a real workspace from your mobile device.</h2>
    <p class="home-page-cta-text">Start with SSH, terminal, editor, and AI Chat. Add Pro when you need Git writes, LSP, debug, sync/cache, and advanced automation.</p>
    <div class="home-page-actions">
      <a href="/download" class="home-page-btn primary">Download NimoteCode</a>
      <a href="/docs/quick-start" class="home-page-btn secondary">Read Quick Start</a>
    </div>
  </div>
</section>
